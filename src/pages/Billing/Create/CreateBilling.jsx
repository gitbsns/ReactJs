...
import billTypeOptions from "data/billTypeOptions";
...
const CreateBilling = ({
  ...
  return (
    <>
      <div className={`grid grid-cols-12 ${styles.createBill}`}>
        <div className={`col-span-2 mt-20 ${styles.leftTop}`}>
                ...
                items={[
                  {
                    key: "1",
                    label: (
                      <div className="text-main text-xs">Billing Notes</div>
                    ),
                    children: (
                      <TextArea
          ...
          <div className="text-xs mt-5 mb-3">Send a copy of the bill to:</div>
          <SendTo
            emailId={emailId}
        ...
        <div className="col-span-8 w-[78%] mx-auto">
          ...
          <div className={`${styles.table} pt-3`}>
            <Table
              className="rounded-lg border h-[311px] relative overflow-auto border-main bg-white"
              columns={columns}
              dataSource={data}
              pagination={false}
              // tableLayout="fixed"
          ...
          <div className="flex justify-end mt-20">
            ...
            {invoiceType ? (
              <Button
                ...
                onClick={() => {
                  if (!invoiceType) {
                    message.error("Please select a bill type to proceed.");
                  }
                  return invoiceType === "Debit Note"
                    ? handleCreateDebitNote()
                    : invoiceType === "Billing"
                    ? handleCreateBilling()
                    : "";
